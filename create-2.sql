...
-- Last modification date: 2024-11-23 00:46:53.812
...
CREATE TABLE Message_Details (
    ...
    UserID1 int  NOT NULL,
    UserID2 int  NOT NULL,
    CONSTRAINT Message_Details_pk PRIMARY KEY (MessageID,UserID1,UserID2)
);
...
CREATE TABLE Userinfo (
    UserID int  NOT NULL,
    ChannelID int  NOT NULL,
    CONSTRAINT Userinfo_pk PRIMARY KEY (UserID,ChannelID)
);
