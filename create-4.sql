...
-- Last modification date: 2024-12-08 20:21:55.305
...
-- Table: Server_Owner
CREATE TABLE Server_Owner (
    UserID int  NOT NULL,
    Date_Owned date  NOT NULL,
    CONSTRAINT Server_Owner_pk PRIMARY KEY (UserID)
);
...
-- Reference: Server_Owner_User (table: Server_Owner)
ALTER TABLE Server_Owner ADD CONSTRAINT Server_Owner_User
    FOREIGN KEY (UserID)
    REFERENCES "User" (UserID)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
...
-- Reference: Server_Server_Owner (table: Server)
ALTER TABLE Server ADD CONSTRAINT Server_Server_Owner
    FOREIGN KEY (OwnerID)
    REFERENCES Server_Owner (UserID)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;

-- Reference: Table_15_User (table: Admin)
ALTER TABLE Admin ADD CONSTRAINT Table_15_User
    FOREIGN KEY (UserID)
    REFERENCES "User" (UserID)  
    NOT DEFERRABLE 
    INITIALLY IMMEDIATE
